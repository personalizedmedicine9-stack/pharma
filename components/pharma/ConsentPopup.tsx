        ...
        >
          ...
          <div className="space-y-3 mb-6">
            {[
              ...
              'For research and educational use only. Not intended for clinical or therapeutic decision-making or as a substitute for professional scientific judgment.',
            ].map((text, i) => (
