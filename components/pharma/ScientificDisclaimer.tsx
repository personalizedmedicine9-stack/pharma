      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 lg:px-12 py-5">
        <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-xl">
          ...
          <div className="text-sm text-amber-800 leading-relaxed space-y-1">
            ...
            <p>For research and educational use only. Not intended for clinical or therapeutic decision-making or as a substitute for professional scientific judgment. Always consult a qualified healthcare professional.</p>
          </div>
        </div>
      </div>
    </div>
