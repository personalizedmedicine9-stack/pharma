...
import { AlertTriangle, FlaskConical, FileText, ExternalLink, ArrowRight, Beaker, Leaf, Hexagon } from 'lucide-react';
          ...
          <div className="space-y-8">
            ...
            <div className="text-center py-8 md:py-10 px-4 bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden relative">
              ...
              <div className="relative z-10">
                ...
                <div className="flex justify-center gap-2 md:gap-3 flex-wrap">
                  <Link
                    href="/interaction"
                    className="flex items-center gap-2 px-4 md:px-6 py-3 bg-red-600 text-white rounded-xl text-xs md:text-sm font-bold shadow-lg hover:bg-red-700 transition-all hover:shadow-xl group"
                  >
                  ...
                  <Link
                    href="/structure"
                    className="flex items-center gap-2 px-4 md:px-6 py-3 bg-cyan-600 text-white rounded-xl text-xs md:text-sm font-bold shadow-lg hover:bg-cyan-700 transition-all hover:shadow-xl group"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h4 className="font-bold text-gray-900 mb-1.5 text-sm">Pharmacology & Phytochemistry Engine</h4>
              ...
              <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h4 className="font-bold text-gray-900 mb-1.5 text-sm">PDF Reports</h4>
                <p className="text-xs text-gray-500 leading-relaxed">Export professional scientific reports with clickable PMID/DOI links and evidence scoring breakdowns.</p>
              </div>
            </div>
          </div>
        </main>
